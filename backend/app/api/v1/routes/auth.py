...
def login(db: DbSession, form_data: Annotated[OAuth2PasswordRequestForm, Depends()]) -> LoginResponse:
...
def refresh(db: DbSession, payload: RefreshRequest) -> LoginResponse:
    try:
